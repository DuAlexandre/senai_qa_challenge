...
const buttons2 = ref([]);
const report = ref('1');
const types = ref([{'id':'1','name':'Colaboradores'},{'id':'2','name':'Departamentos'}]);
...
buttons2.value= [
    {
        ...
        text:'<i class="fa-solid fa-file-excel"></li> Excel',
        className:'inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150'
    },
    {
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <InputLabel for="rep" Value="Relatório:"></InputLabel>
